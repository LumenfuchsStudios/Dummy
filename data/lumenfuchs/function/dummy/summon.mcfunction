## * AydenTFoxx | 2025-01-13 .. 2025-01-13
## * 
...
## Set Health
scoreboard players set @n[type=interaction, tag=lumenfuchs.entity.dummy, distance=..1] lumenfuchs.health 8
