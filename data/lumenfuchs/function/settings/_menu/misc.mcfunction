...
$tellraw @s [ "", \
	...
	{ "text": "Forceload Chunks: ", "color": "gray", "hoverEvent": { "action": "show_text", "contents": [ "If enabled, the Dummy will always forceload its own chunks.", "\n", { "text": "May cause higher usage of resources; If your device can't handle the extra chunks being loaded, consider disabling this.", "color": "gold" } ] } }, \
