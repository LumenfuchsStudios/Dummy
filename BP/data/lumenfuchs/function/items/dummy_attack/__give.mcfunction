...
give @s enchanted_book[ \
	...
	consumable={ animation: "bow", consume_seconds: 4, has_consume_particles: false, on_consume_effects: [ { type: "play_sound", sound: "ambient.cave" } ], sound: "ambient.basalt_deltas.mood" }, \
