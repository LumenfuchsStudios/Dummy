## * AydenTFoxx @ 2025-01-28 .. 2025-03-01
## * 
...
execute unless score #lumenfuchs_dummy.current_version dummy_lib.dummy matches 1.. run scoreboard players set #lumenfuchs_dummy.current_version dummy_lib.dummy 1


## Fix `dummy.material` and `dummy.material_hurt` flags from versions 1.2.2 and earlier

# Move old value to new "_all" flags
execute if score #lumenfuchs_dummy.current_version dummy_lib.dummy matches ..5 run data modify storage lumenfuchs:flags dummy.material_all set from storage lumenfuchs:flags dummy.material
execute if score #lumenfuchs_dummy.current_version dummy_lib.dummy matches ..5 run data modify storage lumenfuchs:flags dummy.material_hurt_all set from storage lumenfuchs:flags dummy.material_hurt

# Remove old (incompatible) flags
execute if score #lumenfuchs_dummy.current_version dummy_lib.dummy matches ..5 run data remove storage lumenfuchs:flags dummy.material
execute if score #lumenfuchs_dummy.current_version dummy_lib.dummy matches ..5 run data remove storage lumenfuchs:flags dummy.material_hurt

# Set new flags to former value
execute if score #lumenfuchs_dummy.current_version dummy_lib.dummy matches ..5 run function lumenfuchs:settings/_utils/bulk_replace_material { setting: "material" }
...
# Update to latest
scoreboard players operation #lumenfuchs_dummy.current_version dummy_lib.dummy = #lumenfuchs_dummy.target_version dummy_lib.dummy
