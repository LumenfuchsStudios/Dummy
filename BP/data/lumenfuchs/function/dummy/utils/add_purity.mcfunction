...
## * 
## * Increments a given player's Purity score.

## ? Function Arguments:
#? player: The UUID of the player to be affected by this function.


# Select target
$tag @p[nbt={ UUID: $(player) }, distance=..8] add lumenfuchs.dummy.tweak_purity
...
$tag @p[nbt={ UUID: $(player) }, distance=..8] remove lumenfuchs.dummy.tweak_purity